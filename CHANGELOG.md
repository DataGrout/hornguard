...
- CI over SWI stable and devel with Scryer and Trealla installed, a weekly run so a changed builtin surfaces early, and a release checklist in `RELEASING.md`.
